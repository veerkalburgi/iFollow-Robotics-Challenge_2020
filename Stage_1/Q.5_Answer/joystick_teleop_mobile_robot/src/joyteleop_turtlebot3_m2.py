...
if __name__ == '__main__':
 while 1:
     if inn==1:
        if turtle.nemo==1: # Move robotwith slow speed
             vel_msg.linear.x=turtle.linear*0.1
             vel_msg.angular.z=turtle.angular*1.2
        elif turtle.semo==1: # Reset odometry
             ...
             for i < max_vel_linear and j < max_vel_angular:
                vel_msg.linear.x=turtle.linear*x
                turtle.linear.x += 0.1
                vel_msg.angular.z=turtle.angular*z
                turtle.angular.z +=0.1
